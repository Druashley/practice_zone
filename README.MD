...
2-11-10: Hoping to get in a quick hour of coding. Might be able to code later tonight. Going to do codewars again today. . Feeling better with Regex everyday. I have a long way to go though. Coded for 60 minutes on some codewars.

2-19-20: Been a crazy start to the new job. Since I  began I haven't had much free time. Got sick. Chippers went missing, and Paul had heart surgery. I should be able to start coding at healthy rate again. Starting today at 3:51 PM. Going to start the to-do project today. 

2-19-20: Felt great to code again. Very happy with what I was able to get started today. Seagull showed me WakaTime! Wakatime will keep track of what I code in VSCode, super bad ass. Got a healthy base started for the todo list project. I would imagine this will take 30-40 hours to start to feel good about.  Worked for 120 minutes today! Back at it again Friday the 21st!
2-19-20: Been a crazy start to the new job. Since I  began I haven't had much free time. Got sick. Chippers went missing, and Paul had heart surgery. I should be able to start coding at healthy rate again. Starting today at 3:51 PM. Going to start the to-do project today.

2-20-20: Got the macbook set up today! I do have a few more VScode things I gotta set up. But that should only take a moment. Otherwise, I think I got most everything set up. I started working on the todo list a little as a test to see if the mac was working. I am not sure how I am going to make an object have a method that spits out something I can append to another dom element. I felt like I was almost there, but it wasn't working just right.. Might take some googling and some more practice. Anyways, Very happy with the mac purchase. If we count set up. I coded for about 120 minutes today. Otherwise, it was only 30 minutes of real coding. haha

2-21-20: Worked on the TODO project in the morning for one hour. Happy with how things are going. Tried to use a flex box for the tasks, but that did not look so great. Whereas, a grid display seems much better. Very happy with how this project is coming together so far. I might code for a bit more later today. Not sure yet.

2-23-20: Got the input field set up for this todo list! All fields work for the most part. I need to get the due date and the priority set up still. Super pumped with the results thus far. 

3-25-20: Wow it has been about a month since I last coded. I have been at my new job almost 60 days now. After I started my new job, step dad had heart surgery and then fell and fractured his back. Been a crazy time taking care of all of that, covid-19 shutting everything down, and working. Hoping to get back into coding. Not going to lie Escape from Tarkov has been the most addictive game I have played in a long time. Blown away at how fun the game is. Ready to code a little though. Not sure if I am going to continue on the todo project like I was working on. I mean it has been a month... I might just start the html/css portion of TOP. Going to ease back into this.

3-26-20: Two days in a row for the first time in a bit! Really enjoying the start to the HTML/CSS section on TOP. Excited to learn today.

3-28-20: Did not get any coding in yesterday. Only did about 30 minutes of reading tonight. It is the GF's and my 2 year mark this weekend! (really the first.) So I have been focused on that more! Excited to code more soon!

3-30-20: Started creating a replica of youtube. Not intended to be Javascript related. Simple css and HTML. It is looking good so far. Happy with the results.